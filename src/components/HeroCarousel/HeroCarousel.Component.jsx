      ...
      <HeroSlider {...settings}>
        {
          images.map((images,index)=>(
            <div className='w-full h-56 md:h-80 py-3' key={index}>
              <img src={`https://image.tmdb.org/t/p/originals${images.backdrop_path}`} alt="hero banner" className='w-full h-full rounded-md object-cover' />
            </div>
          ))
        }
      </HeroSlider>
    ...
    <HeroSlider {...settingsLG}>
        {
          images.map((images,index)=>(
            <div className='w-full h-96 px-2 py-3' key={index} >
              <img src={`https://image.tmdb.org/t/p/originals${images.backdrop_path}`} alt="hero banner" className='w-full h-full rounded-md object-cover object-center' />
            </div>
          ))
        }
    </HeroSlider>
