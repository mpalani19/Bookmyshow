    ...
    <div>
        ...
        <div className='flex flex-col gap-3 lg:hidden'>
            ...
            <div className='flex items-center gap-3 md:px-4'>
                <Button className="bg-red-500 w-full py-3 text-white font-semibold rounded-lg" onClick={rentMovie}>Rent ₹149</Button>
                <Button className="bg-red-600 w-full py-3 text-white font-semibold rounded-lg" onClick={buyMovie}>Buy ₹599</Button>
            </div>
        </div>
